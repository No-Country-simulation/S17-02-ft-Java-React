...
public class AuthController {
    ...
    @Operation(summary = "Registro del usuario(Login)", description = "Registro del usuario y entrega de credenciales", tags = {})
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
                    @Content(schema = @Schema(implementation = AuthResponseDTO.class), mediaType = "application/json") }),
            @ApiResponse(responseCode = "404", content = { @Content(schema = @Schema()) }),
    ...
    // Hay un error presente corregir el manejo de excepciones para que devuelva un
    // json en el body explicando el error
    @Operation(summary = "Verifica el Token", description = "Verifica el Token y devuelve los datos del usuario", tags = {})
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
                    @Content(schema = @Schema(implementation = AuthResponseDTO.class), mediaType = "application/json") }),
