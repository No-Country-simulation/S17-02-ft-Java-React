  ...
  return (
    <div className="register-container">
      ...
      <form onSubmit={handleSubmit} className="form-container">
        ...
        <input type="checkbox" name="terminos" id="" /> <p>Acepto los <span>términos y condiciones</span></p>
        </div>
        <div className="checkbox-footer">
        <input type="checkbox" name="terminos" id="" /> <p>Acepto las <span>políticas de privacidad</span></p>
        </div>
